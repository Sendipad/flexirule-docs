...
| Use Case | Rule Entry Condition | [Condition Action]({{< relref "action-types/condition.md" >}}) |
| :--- | :---: | :---: |
...
A **Rule Entry Condition** acts as a gatekeeper for the entire rule. It is configured as part of the [Rule Trigger Configuration]({{< relref "advanced-concepts/triggers/_index.md" >}}).
...
Use a [Condition Action]({{< relref "action-types/condition.md" >}}) when you need:
