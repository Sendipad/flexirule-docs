...
- **[Action Settings]({{< relref "action-settings.md" >}})**: Configure the details of individual blocks using the Smart Value Selector.
...
Instead of writing scripts, you use the **Smart Value Selector** to pick fields, apply formulas, and set values.
