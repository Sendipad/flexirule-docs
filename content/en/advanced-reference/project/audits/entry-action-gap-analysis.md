...
- **Missing**: No dedicated page in `content/en/core-actions/entry.md`.
...
- **Missing**: No reference in `content/en/advanced-reference/reference/execution/`.
...
- **Missing**: No technical reference in `content/en/advanced-reference/architecture/actions/`.
