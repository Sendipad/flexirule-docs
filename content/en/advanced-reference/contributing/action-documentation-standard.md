...
-   **Location**: `/advanced-reference/reference/execution/<action-slug>.md`
...
-   **Location**: `/advanced-reference/architecture/actions/<action-slug>.md`
...
-   `entity_kind`: The entity classification.
    -   `action`: For the main action landing page (e.g., `core-actions/document-action/_index.md`).
    -   `action_operation`: For specific operation pages within an action (e.g., `core-actions/document-action/create-new.md`).
