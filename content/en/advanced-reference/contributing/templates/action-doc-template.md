...
-->
- [Execution Semantics]({{</* relref "advanced-reference/reference/execution/action-name.md" */>}})
- [Architecture Reference]({{</* relref "advanced-reference/architecture/actions/action-name.md" */>}})
