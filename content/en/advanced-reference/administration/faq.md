...
parent: advanced
aliases:
- /advanced-reference/reference/faq/
---
...
Yes. You can trigger rule execution programmatically using the `flexirule.api.execute_rule` method. For detailed implementation, refer to the [API Reference]({{< relref "advanced-reference/developer-guide/api/" >}}).
{{< /accordion >}}
...
- [Glossary]({{< relref "advanced-reference/reference/glossary.md" >}})
- [Troubleshooting]({{< relref "advanced-reference/administration/troubleshooting.md" >}})
