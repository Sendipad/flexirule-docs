...
parent: advanced
aliases:
- /advanced-reference/reference/troubleshooting/
---
...
- [Rule Builder]({{< relref "using-the-builder/canvas-navigation.md#examples" >}})
- [DocType Reference]({{< relref "advanced-reference/reference/doctypes.md#5-rule-execution-log" >}})
