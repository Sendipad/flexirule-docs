...
### When to Use
- Rule Actions are managed via the [Rule Builder]({{< relref "using-the-builder/canvas-navigation" >}}), which handles the creation of these child records automatically.
...
- [Rule Builder]({{< relref "using-the-builder/canvas-navigation" >}})
