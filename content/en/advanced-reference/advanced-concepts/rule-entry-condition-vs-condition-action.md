...
| Use Case | Rule Entry Condition | [Condition Action]({{< relref "core-actions/check" >}}) |
| :--- | :---: | :---: |
...
A **Rule Entry Condition** acts as a gatekeeper for the entire rule. It is configured as part of the [Rule Trigger Configuration]({{< relref "advanced-reference/advanced-concepts/triggers/_index.md" >}}).
...
Use a [Condition Action]({{< relref "core-actions/check" >}}) when you need:
