...
| Use Case | Rule Entry Condition | [Condition Action]({{< relref "docs/actions/condition/index.md" >}}) |
| :--- | :---: | :---: |
...
A **Rule Entry Condition** acts as a gatekeeper for the entire rule. It is configured as part of the [Rule Trigger Configuration]({{< relref "docs/triggers/_index.md" >}}).
...
Use a [Condition Action]({{< relref "docs/actions/condition/index.md" >}}) when you need:
