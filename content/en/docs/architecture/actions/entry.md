...
If customization is needed for "initialization" logic, it is recommended to use an [Assignment]({{< relref "docs/actions/assignment" >}}) node immediately following the Entry Action.
