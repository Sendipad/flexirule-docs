...
Yes. You can trigger rule execution programmatically using the `flexirule.api.execute_rule` method. For detailed implementation, refer to the [API Reference]({{< relref "docs/developer-guide/api/" >}}).
{{< /accordion >}}
