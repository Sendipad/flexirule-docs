...
### AI Metadata
Actions should include a reference to their AI metadata schema to support rule generation and copilot features. See the [AI Metadata Schema]({{< relref "docs/reference/ai/action-metadata-schema.md" >}}) for details.
