...
### Do Not Use
- Do not use this for simple field updates that can be handled by an [Assignment](../assignment/) action.
- Do not use this for basic branching logic (use [Condition](../condition/) or [Switch](../switch/) instead).
...
**Result**: The credit score is available for subsequent [Condition](../condition/) nodes.
