...
- Use this to simplify logic that would otherwise require multiple nested [Condition]({{< relref "core-actions/condition" >}}) nodes.

### Do Not Use
- Do not use this if you need complex boolean logic (use [Condition]({{< relref "core-actions/condition" >}}) instead).
...
**Result**: Each tier follows its own specific [Assignment]({{< relref "core-actions/assignment" >}}) logic for discounts.
...
- [Condition Action]({{< relref "core-actions/condition" >}})
- [Rule Building]({{< relref "using-the-builder/canvas-navigation.md" >}})
- [Variables Reference]({{< relref "advanced-reference/architecture/resolver/" >}})
