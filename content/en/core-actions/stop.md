...
- **Use Guard Conditions**: Use a [Condition]({{< relref "core-actions/condition" >}}) node before a Stop node to only terminate when necessary.
...
- [Architecture Reference]({{< relref "advanced-reference/architecture/actions/stop.md" >}})
