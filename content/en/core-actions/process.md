...
### Do Not Use
- Do not use this for simple field updates that can be handled by an [Assignment]({{< relref "core-actions/assignment" >}}) action.
- Do not use this for basic branching logic (use [Condition]({{< relref "core-actions/condition" >}}) or [Switch]({{< relref "core-actions/switch" >}}) instead).
...
**Result**: The credit score is available for subsequent [Condition]({{< relref "core-actions/condition" >}}) nodes.
...
- [Process Adapter Standards]({{< relref "advanced-reference/developer-guide/custom-actions/standards" >}})
