...
- **Batch Record Processing**: Iterating over a list of documents fetched by a [Query Records]({{< relref "core-actions/query-records" >}}) action.
...
- **Iterator**: `doc.items`
- **Item Alias**: `line`
- **For Each Path**: A [Condition]({{< relref "core-actions/condition" >}}) node checking if `line.warehouse` is empty, followed by an [Assignment]({{< relref "core-actions/assignment" >}}) or error message.
...
- **Item Alias**: `invoice`
- **For Each Path**: [Assignment]({{< relref "core-actions/assignment" >}}) to update `invoice.status`.
- **After Last Path**: [Notify]({{< relref "core-actions/notify-action" >}}) action to send the summary.
...
- **Minimal Logic**: Keep the logic inside the **For Each** path as lean as possible. If the processing logic is complex, consider moving it into a [Sub-Rule]({{< relref "advanced-reference/triggers/callable-triggers.md" >}}).
...
- **Savepoints**: Loop iterations do not create independent transaction boundaries. Transaction behavior is governed by the parent rule and any nested actions. For details, see [Execution Semantics]({{< relref "advanced-reference/reference/execution/loop.md" >}}).

## Related Topics
- [Execution Semantics]({{< relref "advanced-reference/reference/execution/loop.md" >}})
- [Architecture Reference]({{< relref "advanced-reference/architecture/actions/loop.md" >}})
- [Query Records]({{< relref "core-actions/query-records" >}})
- [Assignment]({{< relref "core-actions/assignment" >}})
